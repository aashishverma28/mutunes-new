...
export function NowPlaying() {
  ...
  return (
    <div className="border-t border-border/40 bg-surface px-6 py-4.5 relative z-20 flex flex-col md:grid md:grid-cols-3 items-center justify-between shadow-2xl shrink-0">
      ...
      {/* Center: Controls */}
      <div className="flex items-center justify-center gap-6 w-full mt-3 md:mt-0">
        <button
      ...
      <div className="hidden items-center justify-end gap-3 md:flex w-full">
        {/* Simple Time Display */}
